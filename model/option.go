...
func InitOptionMap() {
	...
	common.OptionMap["ContentLoggingEnabled"] = strconv.FormatBool(common.ContentLoggingEnabled)
	common.OptionMap["ContentRetentionDays"] = strconv.Itoa(common.ContentRetentionDays)
	common.OptionMap["MaxContentLength"] = strconv.Itoa(common.MaxContentLength)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "ContentLoggingEnabled":
			common.ContentLoggingEnabled = boolValue
	...
	case "ContentRetentionDays":
		common.ContentRetentionDays, _ = strconv.Atoi(value)
